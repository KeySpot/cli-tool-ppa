...
gpg --passphrase RedGreenBlue@1 --default-key $email -abs -o - Release > Release.gpg
gpg --passphrase RedGreenBlue@1 --default-key $email --clearsign -o - Release > InRelease
